...
以一个常见场景为例——年会方案原先定在酒店，因预算缩减改到公司多功能厅，让 AI 更新方案：

| | 输出 |
| --- | --- |
| 未加载技能 | 本次年会不在酒店举办，不设晚宴环节，改为公司多功能厅茶话会。 |
| 加载 final-solution-only | 年会定于公司多功能厅举行，以部门为单位安排茶话与抽奖。 |

场地早就改了，读方案的人只需要知道"今年在哪办"；特意留一句"不在酒店、不设晚宴"，反而让人嘀咕是不是欠了大家一顿晚宴。五个技能的完整对比（每个技能一个日常办公场景的小故事，无需任何技术背景）见 [demo.html](demo.html)，浏览器打开即可查看。
